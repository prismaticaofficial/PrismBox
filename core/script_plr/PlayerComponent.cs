...
{
    /// <summary>
    /// A Component-Based ModPlayer system. Useful for selectively applying logic to players. <br></br>
    /// Any method with the "C_" prefix will run only when the Component is enabled. Unimplemented methods require custom enable logic.
    /// </summary>
